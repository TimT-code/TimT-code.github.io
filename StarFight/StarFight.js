...
var space_view_array=[
  /* Harvested from google images search
...
function build_ship(){//by making the ship build inside a function, and the launching after the function, could relaunch a new ship later after explosion with calling function again.
  ...
  var ship_array=[//Only Transparent gifs/pics
    /*
    {ship_src:'http://www.gifsanimados.org/data/media/635/star-trek-y-viaje-a-las-estrellas-imagen-animada-0010.gif',ship_hp:300},
    {ship_src:'http://bestanimations.com/Sci-Fi/StarTrek/star-trek-4.gif',ship_hp:200},
    {ship_src:'http://i7.photobucket.com/albums/y279/Animated_Avatars/anigalaxy.gif',ship_hp:250},
    {ship_src:'http://www.duveltjes.nl/files/bewegende-animaties/starwars/bewegende-animatie-starwars-678266.gif',ship_hp:400},
    {ship_src:'http://www.duveltjes.nl/files/bewegende-animaties/starwars/bewegende-animatie-starwars-677601.gif',ship_hp:125},
    {ship_src:'http://www.duveltjes.nl/files/bewegende-animaties/starwars/bewegende-animatie-starwars-678171.gif',ship_hp:500},
    {ship_src:'http://www.duveltjes.nl/files/bewegende-animaties/starwars/bewegende-animatie-starwars-405559.gif',ship_hp:225}
    */
...
function make_exp_snd(){
  var exp_snd_array=[
    ...
    'http://trekcore.com/audio/explosions/largeexplosion1.mp3',
    'http://trekcore.com/audio/explosions/largeexplosion2.mp3',
    'http://trekcore.com/audio/explosions/largeexplosion3.mp3',
    'http://trekcore.com/audio/explosions/largeexplosion4.mp3',
    'http://trekcore.com/audio/explosions/smallexplosion1.mp3',
...
function make_perfect_bonus_sound(){
  var perfect_combo_sound_array=[
    ...
    'http://www.thesoundarchive.com/starwars/R2D2.mp3',
...
function make_exp_gif(){
  var expArray = [
   ...
   {exp_src:'http://i651.photobucket.com/albums/uu236/416o/explosion.gif',time_till_gone:800},
   ...
   {exp_src:'https://38.media.tumblr.com/54767e552e0de2a8ae423e56438b73ec/tumblr_msta67lgeE1rmdrjqo1_400.gif',time_till_gone:1800},
   {exp_src:'http://www.netanimations.net/Animated-clip-art-picture-of-black-inferno-fire-flames.gif',time_till_gone:800},
   {exp_src:'https://24.media.tumblr.com/tumblr_md72r6Ui8d1ri9266o1_250.gif',time_till_gone:900},
...
function explosion_gif(){//Function launches upon click of target - Only transparent explosions! - Black background is what I started with when either a transparent, or a Black background would of worked.
  /* Scoring & Bonus Logic */
...
function audio7_func() {/*perfect/bonus*/
  document.getElementById('audio7_id').play();
}
...
var 
    ...
    shotz_src=base_url + '/Images/Firing/' + 'clear.gif',
    shotz_id='shotz_id',
    shotz_size='24';
